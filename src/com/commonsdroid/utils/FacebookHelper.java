...
//			Log.d(TAG, "postPhoto: Session is null");
	...
	/**
	 * The listener interface for receiving onFetchFriends events.
	 * The class that is interested in processing a onFetchFriends
	 * event implements this interface, and the object created
	 * with that class is registered with a component using the
	 * component's <code>addOnFetchFriendsListener<code> method. When
